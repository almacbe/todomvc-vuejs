...
url=`curl -H "Authorization: Bearer $NETLIFY_PUBLISH_KEY" https://api.netlify.com/api/v1/sites/420adf59-058a-4235-b0b3-8326806c97a7/deploys`
...
curl -X POST -H "Authorization: Bearer $NETLIFY_PUBLISH_KEY" -d "{}" "https://api.netlify.com/api/v1/sites/420adf59-058a-4235-b0b3-8326806c97a7/deploys/${temp##*|}/restore"
